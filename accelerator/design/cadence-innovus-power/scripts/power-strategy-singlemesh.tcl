...
addRing -nets {vccd1 vssd1} -type block_rings -around each_block -layer {top met3 bottom met3 left met4 right met4} \
...
sroute -connect {blockPin} -layerChangeRange {met1 met4} -blockPinTarget { blockring } -nets {vccd1 vssd1} -allowLayerChange 1 -blockPin useLef -inst accelerator_inst/instr_mem/genblk1_depth_macro_1__width_macro_0__sram_macro
sroute -connect {blockPin} -layerChangeRange {met1 met4} -blockPinTarget { blockring } -nets {vccd1 vssd1} -allowLayerChange 1 -blockPin useLef -inst accelerator_inst/instr_mem/genblk1_depth_macro_0__width_macro_0__sram_macro
sroute -connect {blockPin} -layerChangeRange {met1 met4} -blockPinTarget { blockring } -nets {vccd1 vssd1} -allowLayerChange 1 -blockPin useLef -inst accelerator_inst/data_mem/genblk1_width_macro_7__sram_macro
sroute -connect {blockPin} -layerChangeRange {met1 met4} -blockPinTarget { blockring } -nets {vccd1 vssd1} -allowLayerChange 1 -blockPin useLef -inst accelerator_inst/data_mem/genblk1_width_macro_6__sram_macro
sroute -connect {blockPin} -layerChangeRange {met1 met4} -blockPinTarget { blockring } -nets {vccd1 vssd1} -allowLayerChange 1 -blockPin useLef -inst accelerator_inst/data_mem/genblk1_width_macro_5__sram_macro
sroute -connect {blockPin} -layerChangeRange {met1 met4} -blockPinTarget { blockring } -nets {vccd1 vssd1} -allowLayerChange 1 -blockPin useLef -inst accelerator_inst/data_mem/genblk1_width_macro_4__sram_macro
sroute -connect {blockPin} -layerChangeRange {met1 met4} -blockPinTarget { blockring } -nets {vccd1 vssd1} -allowLayerChange 1 -blockPin useLef -inst accelerator_inst/data_mem/genblk1_width_macro_3__sram_macro
sroute -connect {blockPin} -layerChangeRange {met1 met4} -blockPinTarget { blockring } -nets {vccd1 vssd1} -allowLayerChange 1 -blockPin useLef -inst accelerator_inst/data_mem/genblk1_width_macro_2__sram_macro
sroute -connect {blockPin} -layerChangeRange {met1 met4} -blockPinTarget { blockring } -nets {vccd1 vssd1} -allowLayerChange 1 -blockPin useLef -inst accelerator_inst/data_mem/genblk1_width_macro_1__sram_macro
sroute -connect {blockPin} -layerChangeRange {met1 met4} -blockPinTarget { blockring } -nets {vccd1 vssd1} -allowLayerChange 1 -blockPin useLef -inst accelerator_inst/data_mem/genblk1_width_macro_0__sram_macro
