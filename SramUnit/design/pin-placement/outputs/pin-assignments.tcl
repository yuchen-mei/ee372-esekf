...
# Pins on the right hand side from top to bottom. I list them out explicitly
# here because the dout0 and din0 pins on the SRAM macro are interleaved
# somewhat randomly, but if in your case the pins of the same bus are to be
# kept together then you can generate this pin list using a tcl for loop
